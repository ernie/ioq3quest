...
================
*/
// ui cvars declared via ui_cvar.h include below
		...
		case UI_UPDATESTATUS:
			{
				...
				case 3:
					...
					label = buf;
					break;
				case 4: label = "Update downloaded. Tap Install to update."; col = &green; break;
				case 5:
...
//			trap_Cvar_Set("cl_maxpackets", "15");
		...
		switch (val) {
			case -2:
				trap_Cvar_SetValue( "r_subdivisions", 2 );  // Ultra
			break;
			case -1:
				trap_Cvar_SetValue( "r_subdivisions", 4 );  // High
			break;
			case 1:
				trap_Cvar_SetValue( "r_subdivisions", 12 ); // Medium
			break;
			case 2:
				trap_Cvar_SetValue( "r_subdivisions", 80 ); // Low
			break;
		}
		...
		switch (val) {
			case 0:	// high quality
				...
				trap_Cvar_SetValue( "r_lodbias", -1 );  // High geometric detail
			...
			case 1: // normal
				...
				trap_Cvar_SetValue( "r_vertexlight", 0 );
				trap_Cvar_SetValue( "r_lodbias", 1 );  // Medium geometric detail
...
static void UI_RunMenuScript(const char **args) {
	...
	if (String_Parse(args, &name)) {
		...
		} else if (Q_stricmp(name, "updateInstall") == 0) {
